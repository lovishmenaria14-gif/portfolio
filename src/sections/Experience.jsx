  ...
  if(layout ==="desktop"){
    return (
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        <motion.div className= "z-10 w-7 h-7 rounded-full bg-white shadow-[0_0_0_8px_rgba(255,255,0.1)]"
        style={{scale,opacity}}
        >
        </motion.div>
...
<div className="relative flex items-start ">
  <motion.div className="absolute -left-[14px] top-3 z-10 w-7 h-7 rounded-full bg-white shadow-[0_0_0_8px_rgba(255,255,0.1)]"
  style = {{scale,opacity}}
  >
