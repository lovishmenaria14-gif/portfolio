...
const experiences = [
  {
    ...
    description:
      "Built responsive web applications using React, JavaScript, and Tailwind CSS. Developed modern user interfaces with smooth animations and optimized user experiences."
  },
  {
    ...
    description:
      "Solved hundreds of DSA problems and strengthened algorithmic thinking through regular coding practice and competitive programming."
  },
  {
    ...
    description:
      "Developed projects including a Portfolio Website, Tic-Tac-Toe Game, and Calculator App using modern web technologies and best development practices."
  }
];
...
function ExperienceItem({ exp, idx, start, end, scrollYProgress, layout }) {
  ...
  if (layout === "desktop") {
    return (
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        <motion.div
          className="z-10 w-7 h-7 rounded-full bg-white shadow-[0_0_0_8px_rgba(255,255,0,0.1)]"
          style={{ scale, opacity }}
        />
  ...
  return (
    <div className="relative flex items-start min-w-0">
      <motion.div
        className="absolute -left-[14px] top-3 z-10 w-7 h-7 rounded-full bg-white shadow-[0_0_0_8px_rgba(255,255,0,0.1)]"
        style={{ scale, opacity }}
      />

      <motion.article
        className="flex-1 min-w-0 ml-6 bg-gray-900/80 backdrop-blur border border-gray-700/70 rounded-xl p-5 shadow-lg"
        style={{ opacity, x }}
        transition={{ duration: 0.4, delay: idx * 0.15 }}
      >
...
<div className="relative flex flex-col gap-10 mt-6 pl-10 pb-28 min-w-0">
  {experiences.map((exp,idx) =>(
    <ExperienceItem
     key ={idx}
    exp = {exp}
