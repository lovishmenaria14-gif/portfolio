...
<footer className="relative overflow-hidden bg-black">
  ...
  >
    ...
    <div className="h-[3px] w-24 md-32 rounded-full bg-gradient-to-r from-[#0d58cc] via-cyan-300 to-emerald-400"/>
    ...
    <p className="text-xs text-gray-400">
      &copy;{new Date().getFullYear()} Lovish Menaria.All rights reserved.
    </p>
