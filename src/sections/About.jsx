...
const stats =[
  {label:"Experience",value:"Just Completed 1st Year"},
  {label:"Speciality",value:"DSA,Volleyball,Dev"},
  ...
  >
    ...
    <div className="flex-1 flex flex-col justify-center text-center md:text-left">
      ...
      <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
         I'm Lovish Menaria, an Electronics and Communication Engineering (ECE) student with a strong passion for software development, problem-solving, and building impactful digital experiences.
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
        ...
        <a href="#contact" className="inline-flex items-center justify-center rounded-lg hover:bg-white/20 text-white bg-white/10 font-semibold px-5 py-3 hover:bg-gray-200 transition
        border border-white/20">Get in Touch</a>
      </div>
...
<p className="text-gray-300 leading-relaxed text-base sm:text-lg">
 My journey into technology began with competitive exam preparation, where I developed discipline, analytical thinking, and perseverance. Over time, I discovered my interest in programming and started exploring web development, data structures & algorithms, and modern software technologies.
</p>
  </motion.div>
